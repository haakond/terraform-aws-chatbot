...
| <a name="input_slack_logging_level"></a> [slack\_logging\_level](#input\_slack\_logging\_level) | Chatbot Slack integration CloudWatch Logs log level. | `string` | `"INFO"` | no |
